...
const Header = () => {
  ...
  return (
    <header
      className={cn(
        "sticky top-0 z-50 mx-2 flex h-14 items-center gap-4 rounded-lg bg-transparent bg-white px-4 shadow-lg transition-all duration-300 lg:h-[60px] lg:px-6",
        navbar && "",
      )}
    >
      <Sheet>
        ...
        <SheetContent side="right" className="flex flex-col bg-white p-1 px-2">
      ...
      <DropdownMenu>
        ...
        >
          ...
          <DropdownMenuItem className="w-full text-right">
            <Link className="w-full" href={routes.employee.profile.details}>
              مشخصات کاربری
            </Link>
          </DropdownMenuItem>
