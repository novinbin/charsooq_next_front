...
const SideBar = () => {
  ...
  return (
    <div className="sticky top-0 h-screen w-0 overflow-hidden bg-white shadow-lg lg:w-1/6">
              ...
              >
                {item.type === "link" && (
                  <Link
                    ...
                    href={item.href}
                    className={cn(
                      "bg-yellow-light flex items-center gap-3 rounded-lg p-2 transition-all duration-100 hover:bg-primary/90 hover:text-white",
                      pathname.endsWith(item.href) && "bg-primary text-white",
                    )}
                  >
                    {item?.icon(18, 1.5)}
                    {item.title}
                ...
                {item.type === "subMenu" && (
                  <div>
                    <div
                      ...
                      className={cn(
                        "bg-yellow-light flex cursor-pointer items-center gap-3 rounded-lg p-2 hover:bg-primary/90 hover:text-white",
                    ...
                    >
                      {item.subMenu.map((subMenuItem, subMenuIndex) => (
                        <Link
                          ...
                          className={cn(
                            "bg-yellow-light flex items-center gap-x-2 rounded-lg p-2 transition-all duration-100 hover:bg-primary/90 hover:text-white",
