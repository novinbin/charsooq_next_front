...
const NoDelay = () => {
  ...
  const fetchCities = async () => {
    await axios
      .get(
        `/api/manager/delay/users/no-delay?page=${searchParams.get("page") || 1}&name=${searchParams.get("name") || ""}&phone=${searchParams.get("phone") || ""}&per_page=${searchParams.get("per_page") || 10}`,
      )
      .then((response) => {
