...
const UsersPage = ({ searchParams: { page }, params: { id } }) => {
  ...
  const fetchCities = async () => {
    ...
    await axios
      .get(
        `/api/employee/user/${id}/factors/delayed?page=${searchParams.get("page") || 1}&per_page=${searchParams.get("per_page") || 10}`,
      )
      .then((response) => {
  ...
  return (
    <div className="px-0 lg:px-10">
      ...
      <Link
        href={routes.employee["factor-registration"].factors.create(id)}
